                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                <div class="file_choose_icon">
                                    <img src="{{ get_site_image_src('brand', !empty($row) ? $row->image : '') }}" alt="matdash-img" class="img-fluid" width="120" height="120">
                                </div>
...
@else
{!!breadcrumb('Brands',url('admin/brands/add/'))!!}
<div class="card"> 
    <div class="card-body">
        <div class="row"> 
            @if (count($rows) > 0)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-6 crud_thumbnail_icon">
                                        <img src="{{ get_site_image_src('brand', !empty($row->image) ? $row->image : '') }}" width="45" class="rounded-circle" />
                                ...
                                <td>
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/brands/edit/' . $row->id) }}">
                                                    <i class="fs-4 ti ti-edit"></i>Edit
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ url('admin/brands/delete/' . $row->id) }}" onclick="return confirm('Are you sure?');">
